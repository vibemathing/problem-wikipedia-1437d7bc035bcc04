...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-1437d7bc035bcc04"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-1437d7bc035bcc04",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-1437d7bc035bcc04",
        "url": "https://en.wikipedia.org/wiki/Repunit"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For any given integer b which is not a perfect power and not of the form −4 k 4 for integer k , are there infinitely many repunit primes to base b ?",
      "version": 1
    },
    "title": "For any given integer b which is not a perfect power and not of the form −4 k 4 for integer k , are there infinitely many repunit primes to base b ?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "6840ace03c5137c140c6381244e77f6f382e658a6f0492dc4302c96ecfabf6b3"
}
```
